 ...
 * @param {Object} [settings] Settings to use when searching for tag functions that precede
 ...
 */
export default function splitFragments(input, settings) {
 ...
 * @returns {Object} A tag settings object that contains the following attributes:
